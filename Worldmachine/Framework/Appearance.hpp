...
namespace worldmachine {
	...
	namespace internal {
		Appearance::Type getCurrentAppearanceType();
	}
	
	void appearanceInspectPanel(Appearance const&, bool& show);
	
	void setImGuiStyleColors(Appearance const&, ImGuiStyle* dst = nullptr);
